  ...
  const renderPickSlots = (picks: string[], team: 'blue' | 'red') => {
    const slots = Array.from({ length: 5 }, (_, i) => {
      ...
      return (
        <div
          key={i}
          className={`w-20 h-36 sm:w-24 sm:h-36 md:w-28 md:h-36 lg:w-32 lg:h-36 xl:w-36 xl:h-36 rounded border-2 flex flex-col relative overflow-hidden transition-all duration-300 ${
            isActiveSlot 
